...
def generateTestCases(fontSourceDir, dbConnection):
    ...
    for i in os.listdir( fontSourceDir ):
        ...
        try:
            ...
            fileInMemory, isFontFuzzed, numberOfBytesChanged = fonts[abspath].fuzzBenStyle(tableToBeFuzzed, fuzzFactor)
            ...
            if isFontFuzzed:
                ...
                query = "INSERT INTO results(md5, bytesChanged, fuzzer, fileName, createTime) VALUES ( '{}', '{}', 'native ben: {}', '{}', '{}')".format(h, numberOfBytesChanged, tableToBeFuzzed, os.path.basename(abspath), datetime.datetime.now() )
                print "WTF", query
                try:
